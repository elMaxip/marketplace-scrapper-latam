...
def test_config(config_file: Callable, config_content: str, acceptable: bool) -> None:
    ...
    key_types: dict[str, Union[Type, Tuple[Type, ...]]] = {
        ...
        "antikeywords_title": (list, type(None)),
        "antikeywords_description": (list, type(None)),
        "exclude_sellers": (list, type(None)),
        "keywords": (list, type(None)),
        "keywords_title": (list, type(None)),
        "keywords_description": (list, type(None)),
        ...
        "excluded_price_pattern_sets": (list, type(None)),
